...
CFG.tokenizer = AutoTokenizer.from_pretrained('../input/huggingface-pretrained-models/Yanhao_simcse_bert_for_patent')
...
for fold in CFG.trn_fold:
    model = CNNModel('../input/huggingface-pretrained-models/Yanhao_simcse_bert_for_patent')
    state = torch.load(f'../input/usp-pth8/USP8/{fold}.pth',
...
submission[['id', 'score']].to_csv('push8.csv', index=False)