...
CFG.tokenizer = AutoTokenizer.from_pretrained('../input/huggingface-pretrained-models/albert_xxlarge_v2')
...
for fold in CFG.trn_fold:
    model = CNNModel('../input/huggingface-pretrained-models/albert_xxlarge_v2')
    state = torch.load(f'../input/usp-pth5/USP5/{fold}.pth',
...
submission[['id', 'score']].to_csv('push5.csv', index=False)