...
CFG.tokenizer = AutoTokenizer.from_pretrained('../input/huggingface-pretrained-models/prithivida_bert_for_patents_64d')
...
for fold in CFG.trn_fold:
    model = CNNModel('../input/huggingface-pretrained-models/prithivida_bert_for_patents_64d')
    state = torch.load(f'../input/usp-pth7/USP7/{fold}.pth',
...
submission[['id', 'score']].to_csv('push7.csv', index=False)