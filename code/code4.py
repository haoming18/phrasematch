...
CFG.tokenizer = AutoTokenizer.from_pretrained('../input/huggingface-pretrained-models/anferico_bert_for_patents')
...
for fold in CFG.trn_fold:
    model = CNNModel('../input/huggingface-pretrained-models/anferico_bert_for_patents')
    state = torch.load(f'../input/usp-pth4/USP4/{fold}.pth',
...
submission[['id', 'score']].to_csv('push4.csv', index=False)